                    ...
                    <div class="x_panel">
                        <div class="x_content">
                            ...
                            <div class="field item form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <select class="form-control selectpicker" disabled>
                                        ...
                                        @foreach ($supir as $s)
                                            <option value="{{ $s->id }}"
                                                {{ $pengecekan->supir_id == $s->id ? 'selected' : '' }}>
                                                {{ $s->nama }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="field item form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <select class="form-control selectpicker" disabled>
                                        ...
                                        @foreach ($mobil as $s)
                                            <option value="{{ $s->id }}"
                                                {{ $pengecekan->mobil_id == $s->id ? 'selected' : '' }}>
                                                {{ $s->plat_mobil }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="field item form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <select class="form-control selectpicker" disabled>
                                        ...
                                        <option value="Pagi"
                                            {{ $pengecekan->shift_pengecekan == 'Pagi' ? 'selected' : '' }}>Pagi</option>
                                        <option value="Siang"
                                            {{ $pengecekan->shift_pengecekan == 'Siang' ? 'selected' : '' }}>Siang</option>
                                        <option value="Malam"
                                            {{ $pengecekan->shift_pengecekan == 'Malam' ? 'selected' : '' }}>Malam</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            @foreach ($status_fields as $field)
                                <div class="field item form-group">
                                    <label
                                        class="col-form-label col-md-3 col-sm-3 label-align">{{ ucfirst(str_replace('_', ' ', $field)) }}</label>
                                    <div class="col-md-6 col-sm-6">
                                        <select class="form-control selectpicker" disabled>
                                            <option readonly value="">Pilih Status</option>
                                            <option value="0" {{ $pengecekan->$field == 0 ? 'selected' : '' }}>Tidak
                                            </option>
                                            <option value="1" {{ $pengecekan->$field == 1 ? 'selected' : '' }}>Ya
                                            </option>
                                        </select>
                                    </div>
                                </div>
                            ...
                            <div class="field item form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    @if ($pengecekan->bukti_video)
                                        <p>File saat ini: <a href="{{ asset('storage/' . $pengecekan->bukti_video) }}"
                                                target="_blank">Lihat Video</a></p>
                                    @else
                                        <p>Tidak ada video</p>
                                    @endif
                                </div>
