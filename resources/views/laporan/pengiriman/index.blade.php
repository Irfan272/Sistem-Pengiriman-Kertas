...
{{-- <script>
    function exportToExcel() {
        ...
        fetch(`/get-pengiriman-data?tanggal_awal=${tanggalAwal}&tanggal_akhir=${tanggalAkhir}`)
            ...
            .then(data => {
                ...
                XLSX.utils.book_append_sheet(wb, worksheet, "Laporan pengiriman Order");

                // Write the workbook to a file
                XLSX.writeFile(wb, `Laporan_pengiriman_${tanggalAwal}_to_${tanggalAkhir}.xlsx`);
            })
            .catch(error => {
