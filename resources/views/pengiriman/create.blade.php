                    ...
                    <div class="x_content">
                        ...
                        <form action="/pengiriman/store" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <select name="supir_id" class="form-control selectpicker" data-live-search="true" required>
                            ...
                            <div class="form-group">
                                ...
                                <select name="pengecekan_mobil_id" class="form-control selectpicker" data-live-search="true" required>
                            ...
                            <div class="form-group">
                                ...
                                <input type="time" name="jam_masuk" class="form-control" required step="1">
                            </div>

                            <div class="form-group">
                                <label for="jam_keluar">Jam Keluar</label>
                                <input type="time" name="jam_keluar" class="form-control" required step="1">
                            </div>
